 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PrintManifestResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'printManifestResponse';
     ...
     * Sets manifest
     *
     * @param string $manifest Customer Collection Receipt in PDF format -Base64 encoded for transfer
     *
     * @return $this
     */
