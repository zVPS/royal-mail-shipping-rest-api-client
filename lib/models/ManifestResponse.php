...
class ManifestResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets batchNumber
     *
     * @param int $batchNumber The batch number of the manifest. It is a sequentially allocated number. Used in subsequent call to the create manifest label operation.
     *
     * @return $this
     */
     ...
     * Sets count
     *
     * @param int $count Total number of shipments on this manifest
     *
     * @return $this
     */
     ...
     * Sets manifest
     *
     * @param string $manifest Customer Collection Receipt in PDF format - Base64 encoded for transfer. Returned here when 'Include the Manifest Image in 'createManifest' response' is enabled in Pro Shipping GUI.
     *
     * @return $this
     */
