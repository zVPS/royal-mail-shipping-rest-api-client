...
'manifests' => '\RoyalMail\Shipping\Rest\Api\models\Manifest[]',
'httpStatusCode' => 'int',
...
'errors' => 'getErrors'    ];
     ...
     *
     * @param string $postingLocation Posting Location.<br />The Posting Location manifested
     *
     * @return $this
     */
     ...
     * Gets manifests
     *
     * @return \RoyalMail\Shipping\Rest\Api\models\Manifest[]
     */
     ...
     * Sets manifests
     *
     * @param \RoyalMail\Shipping\Rest\Api\models\Manifest[] $manifests The Created Manifests<br />Only populated if the request was successful.
     *
     * @return $this
     */
