...
class Contact implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $complementaryName Business name. If using the Local Collect option, the name format must be&#58; \\'C/O\\' + Location Name + \\'Post Office\\' or \\'Enquiry Office\\' E.g. \"C/O Mount Pleasant Post Office
     *
     * @return $this
     */
     ...
     *
     * @param string $telephoneNumber UK mobile phone number. Required if a SMS service enhancement is selected. Conditionally required if using Local Collect service enhancement.
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string $email Email address to be used for notifications. Required if Email enhancement is selected. Conditionally required if using Local Collect service enhancement.
     *
     * @return $this
     */
