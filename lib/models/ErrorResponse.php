...
class ErrorResponse implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['httpMessage'] = isset($data['httpMessage']) ? $data['httpMessage'] : null;
        $this->container['moreInformation'] = isset($data['moreInformation']) ? $data['moreInformation'] : null;
    }
     ...
     * Sets httpCode
     *
     * @param string $httpCode HTTP error code. As per the *httpMessage* and *moreInformation* fields below, this field is only returned for API Gateway level errors when requests are not accepted for processing.
     *
     * @return $this
     */
    ...
    {
        return $this->container['httpMessage'];
    }

    /**
     * Sets httpMessage
     *
     * @param string $httpMessage HTTP error code description. For API Gateway level errors.
     *
     * @return $this
     */
    public function setHttpMessage($httpMessage)
    {
        $this->container['httpMessage'] = $httpMessage;

        return $this;
    }

    /**
     * Gets moreInformation
     *
     * @return string
     */
    public function getMoreInformation()
    {
        return $this->container['moreInformation'];
    }

    /**
     * Sets moreInformation
     *
     * @param string $moreInformation Information relating to the error condition. For API Gateway level errors.
     *
     * @return $this
     */
    public function setMoreInformation($moreInformation)
    {
        $this->container['moreInformation'] = $moreInformation;
