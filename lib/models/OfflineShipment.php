...
class OfflineShipment implements ModelInterface, ArrayAccess
{
     ...
     * Sets number
     *
     * @param string $number Not Currently Available. Offline 1D Linear Barcode number assigned to the shipment. This should be from the 1D barcode range received by you in response to request1Drange
     *
     * @return $this
     */
     ...
     * Sets itemID
     *
     * @param string $itemID Not Currently Available. Offline 2D Item ID number assigned to the shipment. This should be from the 2D barcode range received by you in response to request2Drange
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Not Currently Available. Code for status of Offline Shipment. Valid values are 'AllocatedOffline'. You have to call the *label* operation before adding the shipment to the manifest, and ‘PrintedOffline’  label is not required when using this status in this operation.
     *
     * @return $this
     */
