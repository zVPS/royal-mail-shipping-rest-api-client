...
/**
 * RecipientContact Class Doc Comment
 *
 * @category Class
 * @package  RoyalMail\Shipping\Rest\Api
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RecipientContact implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'recipientContact';
    ...
    protected static $setters = [
        'name' => 'setName',
        'complementaryName' => 'setComplementaryName',
        'telephoneNumber' => 'setTelephoneNumber',
        'electronicAddress' => 'setElectronicAddress'
    ];
    ...
    protected static $getters = [
        'name' => 'getName',
        'complementaryName' => 'getComplementaryName',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['complementaryName'] = isset($data['complementaryName']) ? $data['complementaryName'] : null;
        $this->container['telephoneNumber'] = isset($data['telephoneNumber']) ? $data['telephoneNumber'] : null;
        $this->container['electronicAddress'] = isset($data['electronicAddress']) ? $data['electronicAddress'] : null;
    }
    ...
    /**
     * Gets complementaryName
     *
     * @return string
     */
    public function getComplementaryName()
    {
        return $this->container['complementaryName'];
    }

    /**
     * Sets complementaryName
     *
     * @param string $complementaryName Business name
     *
     * @return $this
     */
    public function setComplementaryName($complementaryName)
    {
        $this->container['complementaryName'] = $complementaryName;
     ...
     *
     * @param string $telephoneNumber UK mobile phone number. Required if a SMS service enhancement is selected.
     *
     * @return $this
     */
    ...
    /**
     * Gets electronicAddress
     *
     * @return string
     */
    public function getElectronicAddress()
    {
        return $this->container['electronicAddress'];
    }

    /**
     * Sets electronicAddress
     *
     * @param string $electronicAddress Email address to be used for notifications. Required if Email enhancement is selected
     *
     * @return $this
     */
    public function setElectronicAddress($electronicAddress)
    {
        $this->container['electronicAddress'] = $electronicAddress;
